...
app_logo = Label(frameCima, image=app_img, text=' Personal Finance', width=900, compound=LEFT, padx=5, relief=RAISED, anchor=NW, font=('Verdana 20 bold'), background= co1, fg=co4)
...
def porcentagem():
    ...
    l_porcentagem = Label(frameMeio, text=f"{valor:,.2f}", anchor=NW, font='VERDANA 12', bg=co1, fg=co4)
...
botao_deletar = Button(frame_operacoes, command=deletar, image=img_delete, compound=LEFT, anchor=NW, text="   Deletar".upper(), width=80, overrelief=RIDGE,  font=('ivy 7 bold'),bg=co1, fg=co0 )
...
e_nome = Entry(frame_configuracao, width=14, justify='left',relief="solid")
e_nome.place(x=110, y=160)
